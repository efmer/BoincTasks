...
/*
BOOL CALLBACK SymbolServerCallbackProc64(UINT_PTR ActionCode, ULONG64 CallbackData, ULONG64)
{
    BOOL bRetVal = FALSE;
...
/*
BOOL CALLBACK SymRegisterCallbackProc64(HANDLE , ULONG ActionCode, ULONG64 CallbackData, ULONG64)
{
    BOOL bRetVal = FALSE;
    PIMAGEHLP_CBA_EVENT pEvent = NULL;
...
/*
BOOL CALLBACK SymEnumerateModulesProc64(LPCSTR , DWORD64 BaseOfDll, PVOID )
{
