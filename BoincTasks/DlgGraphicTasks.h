...
public:
	...
	std::deque<CHistoryProjectTasksItem*> *m_plHistoryProjectTasks;
};
...
class CThreadRpc;
class CDlgGraphicTasks : public CDialog
{
	DECLARE_DYNAMIC(CDlgGraphicTasks)

public:
	CDlgGraphicTasks(CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlgGraphicTasks();
...
protected:
	...
	virtual BOOL PreTranslateMessage(MSG* pMsg);
			...
			void GetAverage(std::deque<CHistoryProjectTasksItem*> *plHistoryProjectTasksItem, int *piDay, int *piWeek);
